...
...jest.requireActual('../state/new actions/projectAction'),
  updatingProjectServiceParameterDetailsAPI: jest.fn(),
}));
...
describe('Project ServiceModal', () => {
    ...
    it('renders correctly', () => {
      ...
      render(<ServiceModal projectId={"098"} isOpen={true} handleClose={handleClose} document={documentMock} />);
    ...
    it('checks for the parameters', () => {
        const handleClose = jest.fn();
        const {queryByText}=render(<ServiceModal projectId={"098"} isOpen={true} handleClose={handleClose} document={documentMock} />);
    ...
    it('submits the form with updated values', async () => {
      ...
      it('No Parameters', () => {
        const handleClose = jest.fn();
        render(<ServiceModal projectId={"098"} isOpen={true} handleClose={handleClose} document={anotherdocumentMock} />);
