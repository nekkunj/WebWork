...
jest.mock('../state/new actions/organizationAction', () => ({
    ...
    assignNewService: jest.fn().mockImplementation(() => Promise.resolve()), 
}));
...
const mockCardData = [
    { name: 'Test Service', createdOn: '2023-08-08T21:49:31.456Z', url: 'test.com',serviceParameters:JSON.stringify(jsonObject) },
    { name: 'Test Service 2', createdOn: '2023-08-08T21:49:31.456Z', url: 'test.com',serviceParameters:JSON.stringify([]) },
...
describe('AddServiceModal Under Organization', () => {
...
//         });
//         await waitFor(() => {
//             expect(screen.queryByText("Please complete the service form")).toBeInTheDocument(); 
