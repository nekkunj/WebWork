...
function ServiceModal({isOpen,handleClose,document,orgId}:IServiceModal){
  ...
  const onFinish=async (val:any)=>{
    ...
    // setLoading(true);
      await updatingServiceParameterDetailsAPI(data,getToken(),handleLogoutRedirect)
        setOpen(false);
        handleClose() 
    ...
    return(
        ...
        {document.parameterJsonData==null && <> This service has no parameters</>}
        {document.parameterJsonData=="" && <> This service has no parameters</>}
